...
from .tools import web_search_records, search_knowledge_base_records
...
def _invoke_json_agent(state: ResearchState, prompt: str, agent, agent_name: str, node: str, fallback: dict, writer: StreamWriter | None = None) -> tuple[dict, str, list]:
...
def intent_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def direct_answer_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def plan_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def web_search_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def local_rag_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def deep_dive_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def analyze_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def reflect_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
...
def _check_evidence_sufficiency(state: ResearchState) -> tuple[bool, str]:
    """检查证据是否足够生成可靠报告。
...
def write_node(state: ResearchState, agent, agent_name: str, writer: StreamWriter | None = None) -> ResearchState:
